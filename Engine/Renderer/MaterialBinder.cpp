...
void MaterialBinder::Bind(const Material& material) const
{
    ...
    const BufferSlice materialSlice = m_BufferManager->UploadUniformRing(BufferBindingSlot::Material, materialData);
    m_BufferManager->BindRange(BufferBindingSlot::Material, materialSlice.offset, materialSlice.size);
