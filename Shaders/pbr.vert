...
void main()
{
    mat4 modelMatrix4 = uModelMatrices[gl_InstanceID];
    vec4 worldPosition = modelMatrix4 * vec4(aPosition, 1.0);
    mat3 normalMatrix = transpose(inverse(mat3(modelMatrix4)));
    mat3 modelMatrix = mat3(modelMatrix4);
